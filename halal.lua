...
if not isfile("Garbage/halal.mp3") then writefile("Garbage/halal.mp3", game:HttpGet("https://cdn.discordapp.com/attachments/1010829231879626763/1014535292780302409/Al_Qaedirection.mp3")) end
